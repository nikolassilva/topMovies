...
import 'package:movies_app/models/movie_genre_model.dart';
import 'package:movies_app/models/production_company_model.dart';
import 'package:movies_app/models/production_country_model.dart';
import 'package:movies_app/models/spoken_language_model.dart';
...
class MovieDetailModel {
  ...
  factory MovieDetailModel.fromJsom(String str) =>
  ...
  factory MovieDetailModel.fromMap(Map<String, dynamic> json) =>
      MovieDetailModel(
        ...
        genres: List<MovieGenreModel>.from(
            json["genres"].map((x) => MovieGenreModel.fromMap(x))),
